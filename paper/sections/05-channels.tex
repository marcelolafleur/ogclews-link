...
non-negligible effect. Incidence is the channel's second output: with
...
not the burden or the dose-response. The mechanism---endogenous demography driven
by an emissions signal---requires an age-structured equilibrium model.
