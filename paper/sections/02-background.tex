...
Two recent frameworks sit nearest to this work. IEEM \citep{banerjee_ieem_2020}, the Inter-American Development Bank's
...
neither---nor, yet, ours---is a numerical \emph{fixed-point iteration}. This is standard
practice rather than a defect: our own channels carry reduced-form coefficients
too (\Cref{sec:calibration}), and our loop
...
explicitly---named channels carrying one signal into one
