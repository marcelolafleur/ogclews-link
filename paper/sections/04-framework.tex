...
validation that fires when a mapping is large or ill-posed. Nothing country-specific
is fixed in the framework: which industry is electricity, and how many industries and
goods the country resolves, are read from the calibration and the declared concordance
at run time (\Cref{sec:architecture}).
...
is implemented. Now trace where the higher price goes.
