...
otherwise the levelized cost of electricity (LCOE) reconstructed from the run's
...
(uncalibrated) money units cancel. For the Philippine reform this LCOE ratio averages
about $1.05$ (rising to $1.16$ by 2030). It is transmitted through the composite of \Cref{sec:routes}: an
